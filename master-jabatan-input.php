			...
			<main class="app-main">
				...
				<div class="app-content-header">
					<div class="container-fluid">
						<div class="row">
							<div class="col-sm-6">
								<h3 class="mb-0">Input Jabatan Pegawai</h3>
							</div>
							<div class="col-sm-6">
                                    ...
                                    <form action="proses/proses-jabatan.php?aksi=inputjabatan" method="POST">
									    <div class="card-body">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="kode" name="kode" placeholder="Masukkan Kode Jabatan Pegawai" required>
                                            </div>
											<div class="mb-3">
												<label for="nama" class="form-label">Nama Jabatan</label>
												<input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama Jabatan Pegawai" required>
											</div>
                                        </div>
